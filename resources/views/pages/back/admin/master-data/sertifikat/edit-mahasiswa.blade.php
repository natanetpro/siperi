...
@section('content')
    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.master-data.sertifikat.update-mahasiswa') }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_pemimpin') is-invalid @enderror"
                                name="nama_pemimpin" required value="{{ $certificate->nama_pemimpin }}" />
                            @error('nama_pemimpin')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('jabatan_pemimpin') is-invalid @enderror"
                                name="jabatan_pemimpin" required value="{{ $certificate->jabatan_pemimpin }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('nip_pemimpin') is-invalid @enderror"
                                name="nip_pemimpin" required value="{{ $certificate->nip_pemimpin }}" />
                            @error('nip_pemimpin')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
