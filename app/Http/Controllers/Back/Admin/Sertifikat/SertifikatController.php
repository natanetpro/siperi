...
class SertifikatController extends Controller
{
    ...
    public function downloadCertificate($id)
    {
        ...
        if ($userKegiatan->kegiatan->jenis_kegiatan === 'Prakerin') {
            $certificate = asset('sertifikat-prakerin.png');
            // dd($certificate);
            $im = imagecreatefrompng($certificate);
            ...
            $box->setBox(1330, 1320, 500, 500);
            $box->setTextAlign('left', 'center');
            $box->draw($userKegiatan->user->pemohon->detailPemohonSekolah->nis);
            ...
            $box->setBox(1325, 1230, 1000, 1000);
            $box->setTextAlign('left', 'center');
            $box->draw($userKegiatan->user->pemohon->detailPemohonSekolah->jurusan);
            ...
            $box->setBox(1320, 1305, 1000, 1000);
            $box->setTextAlign('left', 'center');
            $box->draw($userKegiatan->user->pemohon->detailPemohonSekolah->kelas);
            ...
            $box->setBox(1320, 1490, 800, 800);
            $box->setTextAlign('left', 'center');
            $box->draw($userKegiatan->user->pemohon->detailPemohonSekolah->sekolah);
